  ...
  return (
    <div className="relative py-12">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute w-64 h-64 -left-32 top-0 bg-rose-500/20 rounded-full mix-blend-multiply filter blur-3xl animate-blob" />
        <div className="absolute w-64 h-64 -right-32 top-0 bg-amber-500/15 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-2000" />
          ...
          <div className="flex">
            {carouselImages.map((image, index) => (
              ...
              >
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-rose-500/30 to-pink-500/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  <Image
                    src={
